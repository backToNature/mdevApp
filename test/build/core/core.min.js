(function() {
    ...
    define("D:/dev/mdevApp/test/build/core/router/load-module.js", function(require, exports, module) {
        var $$data = require("D:/dev/mdevApp/test/build/core/util/data-center.js"), debug = $.cookie()["debug_cookie"], $$module = require("D:/dev/mdevApp/test/build/core/router/module.js"), modules = {};
        var loadModule = function(pageName, data, api) {
            ...
            newModuleList.forEach(function(item) {
                ...
                if (debug === "true") {
                    ...
                    $.when($.loadCss(item.replace(".js", ".css")), $.getScript(item.replace(".js", ".min.js"))).done(done);
                }
            });
        };
